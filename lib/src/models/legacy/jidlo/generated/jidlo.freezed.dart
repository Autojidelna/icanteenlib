...
@JsonKey(name: 'varianta') String get varianta;///Lze objednat?
...
@JsonKey(name: 'den') DateTime get den;/// URL pro požadavek na objednání jídla
...
@useResult
$Res call({
@JsonKey(name: 'objednano') bool objednano,@JsonKey(name: 'varianta') String varianta,@JsonKey(name: 'lzeObjednat') bool lzeObjednat,@JsonKey(name: 'naBurze') bool naBurze,@JsonKey(name: 'den') DateTime den,@JsonKey(name: 'orderUrl') String? orderUrl,@JsonKey(name: 'burzaUrl') String? burzaUrl
});
...
/// Create a copy of Jidlo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? objednano = null,Object? varianta = null,Object? lzeObjednat = null,Object? naBurze = null,Object? den = null,Object? orderUrl = freezed,Object? burzaUrl = freezed,}) {
  return _then(_self.copyWith(
objednano: null == objednano ? _self.objednano : objednano // ignore: cast_nullable_to_non_nullable
as bool,varianta: null == varianta ? _self.varianta : varianta // ignore: cast_nullable_to_non_nullable
as String,lzeObjednat: null == lzeObjednat ? _self.lzeObjednat : lzeObjednat // ignore: cast_nullable_to_non_nullable
...
as DateTime,orderUrl: freezed == orderUrl ? _self.orderUrl : orderUrl // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'objednano')  bool objednano, @JsonKey(name: 'varianta')  String varianta, @JsonKey(name: 'lzeObjednat')  bool lzeObjednat, @JsonKey(name: 'naBurze')  bool naBurze, @JsonKey(name: 'den')  DateTime den, @JsonKey(name: 'orderUrl')  String? orderUrl, @JsonKey(name: 'burzaUrl')  String? burzaUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Jidlo() when $default != null:
return $default(_that.objednano,_that.varianta,_that.lzeObjednat,_that.naBurze,_that.den,_that.orderUrl,_that.burzaUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'objednano')  bool objednano, @JsonKey(name: 'varianta')  String varianta, @JsonKey(name: 'lzeObjednat')  bool lzeObjednat, @JsonKey(name: 'naBurze')  bool naBurze, @JsonKey(name: 'den')  DateTime den, @JsonKey(name: 'orderUrl')  String? orderUrl, @JsonKey(name: 'burzaUrl')  String? burzaUrl)  $default,) {final _that = this;
switch (_that) {
case _Jidlo():
return $default(_that.objednano,_that.varianta,_that.lzeObjednat,_that.naBurze,_that.den,_that.orderUrl,_that.burzaUrl);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'objednano')  bool objednano, @JsonKey(name: 'varianta')  String varianta, @JsonKey(name: 'lzeObjednat')  bool lzeObjednat, @JsonKey(name: 'naBurze')  bool naBurze, @JsonKey(name: 'den')  DateTime den, @JsonKey(name: 'orderUrl')  String? orderUrl, @JsonKey(name: 'burzaUrl')  String? burzaUrl)?  $default,) {final _that = this;
switch (_that) {
case _Jidlo() when $default != null:
return $default(_that.objednano,_that.varianta,_that.lzeObjednat,_that.naBurze,_that.den,_that.orderUrl,_that.burzaUrl);case _:
  return null;
...
class _Jidlo implements Jidlo {
  const _Jidlo({@JsonKey(name: 'objednano') required this.objednano, @JsonKey(name: 'varianta') required this.varianta, @JsonKey(name: 'lzeObjednat') required this.lzeObjednat, @JsonKey(name: 'naBurze') required this.naBurze, @JsonKey(name: 'den') required this.den, @JsonKey(name: 'orderUrl') this.orderUrl, @JsonKey(name: 'burzaUrl') this.burzaUrl});
...
/// Create a copy of Jidlo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? objednano = null,Object? varianta = null,Object? lzeObjednat = null,Object? naBurze = null,Object? den = null,Object? orderUrl = freezed,Object? burzaUrl = freezed,}) {
  return _then(_Jidlo(
objednano: null == objednano ? _self.objednano : objednano // ignore: cast_nullable_to_non_nullable
as bool,varianta: null == varianta ? _self.varianta : varianta // ignore: cast_nullable_to_non_nullable
as String,lzeObjednat: null == lzeObjednat ? _self.lzeObjednat : lzeObjednat // ignore: cast_nullable_to_non_nullable
