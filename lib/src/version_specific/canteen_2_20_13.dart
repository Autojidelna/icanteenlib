...
class Canteen2v20v13 extends BaseCanteen {
  Canteen2v20v13(super.url, super.webVerze) {
    _cookies = {"JSESSIONID": "", "XSRF-TOKEN": ""};
  }

  @override
  String get verzeKnihovny => "2.20.13";

  @override
  // TODO: implement featureSupport
  FeatureSupport get featureSupport => FeatureSupport(unsupportedByCanteen: [Features.alergeny, Features.burza]);
  ...
  Future<String> _strankaSpecifickyJidelnicekRequest(DateTime datum) async {
    ...
    return await $getRequest(
      url,
      "/faces/secured/main.jsp?$vydejna&day=${datum.year}-${(datum.month < 10) ? "0${datum.month}" : datum.month}-${(datum.day < 10) ? "0${datum.day}" : datum.day}&terminal=false&printer=false&keyboard=false",
      _buildCookieHeader(),
      _cookies,
    );
  }
