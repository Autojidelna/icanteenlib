...
class Canteen2v16v15 extends BaseCanteen {
  Canteen2v16v15(super.url, super.webVerze) {
    _cookies = {"JSESSIONID": "", "XSRF-TOKEN": ""};
  }

  @override
  String get verzeKnihovny => "2.16.15";
  ...
  @override
  String _strankaNastaveniPath() => 'faces/secured/setting.jsp?terminal=false&keyboard=false&printer=false';
  ...
  String _strankaVsechJidelnickuPath() {
    ...
    return '/faces/secured/mobile.jsp?${vydejna}terminal=false&printer=false&keyboard=false';
  }
